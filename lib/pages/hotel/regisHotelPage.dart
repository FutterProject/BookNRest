...
class regisHotelPage extends StatefulWidget {
  const regisHotelPage({super.key});

  @override
  State<regisHotelPage> createState() => _regisHotelPageState();
}

class _regisHotelPageState extends State<regisHotelPage> {
              ...
              Column(
                ...
                children: [
                    ...
                    TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text: 'Hotel',
                          style: TextStyle(
                            color: Color.fromRGBO(116, 96, 179, 1),
                          ),
                        ),
                      ],
                    ),
                  ...
                  Text(
                    ...
                    'dream hotel stays. Fill in the required information below to create your hotel account'
